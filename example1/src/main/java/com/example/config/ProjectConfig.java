...
public class ProjectConfig {
    ...
    **/
    ...
    // The string object gets converted into spring bean
    @Bean
    String hello(){
        return "Hello World";
    }

    // The integer object gets converted into spring bean
    /* use noun style of naming conventions -
    as inside IOC container - bean name will be this.
    * */
    @Bean
    Integer number() {
        return 16;
